<template>
  <div id="micro-app">
    ...
    <el-button plain size="mini" @click="loadApp"> 加载 Vue 子应用 </el-button>
...
export default {
  name: "App",
  computed: mapState(["basename", "mainAppProps"]),

  methods: {
    async loadApp() {
      window.Garfish.router.push({
        path: "/vue2/micro-app/vueApp",
        basename: "/",
      });
    },
    async loadAppReact() {
      window.Garfish.router.push({
        path: "/vue2/micro-app/reactApp",
        basename: "/",
      });
    },
  },
